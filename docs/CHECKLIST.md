...
- [ ] Collection `DevFestComp2025` exists (created on first submission)
- [ ] Folder `devfest2025Comp` accessible

### Clerk Configuration

- [ ] Clerk application created
- [ ] Sign-in methods configured
- [ ] Development domain added (`localhost:3000`)
- [ ] Public keys copied to `.env.local`
...
- [ ] Clerk domain added (your-app.vercel.app)
